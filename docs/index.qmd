...
To fully complete this training, you must have access to RStudio (or another suitable R environment). Some functionality cannot run in this interactive platform alone.
...
gev_pars_27028 <- as.numeric(GEVPars(flow_27028, _______ = _______))
gev_pars_27028
...
# Estimate the GEV parameters from sample data 
# (do not use maximum likelihood estimation)
gev_pars_27028 <- as.numeric(GEVPars(flow_27028, mle = _______))
gev_pars_27028
...
# Estimate the GEV parameters from sample data 
# (do not use maximum likelihood estimation)
gev_pars_27028 <- as.numeric(GEVPars(flow_27028, mle = FALSE))
gev_pars_27028
