...
# generalised logistic distribution (genlog_pars_2001_MLE is first converted 
# to a numeric vector to remove incorrect labels from the outputs)
genlog_pars_2001_MLE <- as.numeric(genlog_pars_2001_MLE)
...
The Environment Agency commissioned the creation of this training material and would be grateful for any feedback via this form: [**UKFE Training Feedback Form**](https://forms.office.com/pages/responsepage.aspx?id=UCQKdycCYkyQx044U38RAotTiwayVnVFvkuMqrG-O_RUNlJBMkxUSjc1VVRUQjBFTVdGMjlRUVBaQi4u&route=shorturl)
